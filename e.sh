...
CONFIGFOLDER='/root/.luq'
COIN_DAEMON='/usr/local/bin/luqd'
COIN_CLI='/usr/local/bin/luq-cli'
COIN_REPO='https://github.com/luniquecoin/LuniqueCoin/archive/v3.0.tar.gz'
COIN_NAME='LuniqueCoin'
COIN_PORT=30001
